...
public class CustomPersonalDataForm implements FormAuthenticator, FormAuthenticatorFactory {
    ...
    public Response render(FormContext context, LoginFormsProvider form) {
        ...
        // Passer formData au RegisterBean pour que le template puisse accéder aux
        // valeurs saisies
        ...
        return form.createForm("register-custom-personal-data.ftl");
    }
